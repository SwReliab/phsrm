...
public class HErSRMPanel extends JPanel implements ActionListener {
...
//		rightPanel.add(maxItePane);
	...
	public void setHErSRM(HyperErlangSRM srm) {
		this.srm = srm;
		update();
	}
...
//			estResult.append("BIC: " + InformationCriteria.getBIC(srm.getNHPPModel(), dat) + ln);
			...
			estResult.append("Total computatin time = " + srm.getTotalComputationTime() + " (sec)" + ln);
